...
type TextoSwift struct {
	Title string `json: "title"`
	Data  string `json: "data"`
}

func tradSwift(w http.ResponseWriter, r *http.Request) {
	var textnuevo TextoSwift
	err := json.NewDecoder(r.Body).Decode(&textnuevo)
	if err != nil {
...
func main() {
	...
	r.HandleFunc("/texto", tradSwift).Methods("POST")
